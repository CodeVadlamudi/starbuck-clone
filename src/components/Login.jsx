...
function Login() {
  const formLogin = [
    { name: "Username", type: "text", title: "Enter email" },
    { name: "Password", type: "password", title: "Enter Password" },
  ];
  return (
    <div>
      <div className="h-[90vh] grid place-items-center p-10">
        <div className="bg-white max-w-[500px] w-full shadow-xl rounded-2xl p-10 border">
